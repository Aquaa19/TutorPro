# <div align="center"><img src="/public/logo.png" width="48" height="48" style="vertical-align: middle; margin-right: 10px;" /><br>TUTORPRO.OS</div>
...
<div align="center">
  ...
  [![Google Gemini](https://img.shields.io/badge/Gemini_AI-15B2D6?style=for-the-badge&logo=google-gemini&logoColor=white)](https://ai.google.dev/)
  [![Platform Android](https://img.shields.io/badge/Platform-Android_WebView-3DDC84?style=for-the-badge&logo=android&logoColor=white)](#-mobile-companion-app)
...
<img src="./releases/gallery/desktop/desktop_01_login.png" alt="Secure Login Portal" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
...
<!-- Slide 2 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_02_onboarding.png" alt="Guided Onboarding" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 3 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_03_dashboard.png" alt="Analytics Dashboard" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 4 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_04_batches.png" alt="Batch Management" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 5 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_05_student_profile.png" alt="Student Profile Hub" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 6 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_06_dossier_ledger.png" alt="Dossier Ledger" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 7 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_07_attendance.png" alt="Attendance Manager" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 8 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_08_finances.png" alt="Financial Console" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 9 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_09_exams.png" alt="Exams & Grading" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 10 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_10_ai_reports.png" alt="AI Reports Engine" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<!-- Slide 11 -->
<div style="flex: 0 0 85%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px;">
<img src="./releases/gallery/desktop/desktop_11_pdf_invoice.png" alt="Invoice & Receipting" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.08); width: 100%; height: auto; display: block;" />
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 16px; display: flex; flex-direction: column; gap: 8px; text-align: left;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 6px; background: rgba(99, 102, 241, 0.15); color: #a5b4fc; border: 1px solid rgba(99, 102, 241, 0.2); display: inline-block;">Desktop Portal</span>
...
<img src="./releases/gallery/mobile/mobile_01_login.png.png" alt="Secure Login Portal" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_02_onboarding.png.png" alt="Guided Onboarding" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_03_dashboard.png.png" alt="Analytics Dashboard" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_04_batches.png.png" alt="Batch Management" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_05_student_profile.png.png" alt="Student Profile Hub" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_06_dossier_chart.png.png" alt="Dossier Ledger" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_07_mark_attendance.png.png" alt="Attendance Manager" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_08_finances.png.png" alt="Financial Console" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_09_exams.png.png" alt="Exams & Grading" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_10_ai_reports.png.png" alt="AI Reports Engine" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<div style="flex: 0 0 100%; scroll-snap-align: start; box-sizing: border-box; display: flex; flex-direction: column; gap: 12px; height: 100%; padding: 10px; text-align: left;">
<div style="flex-grow: 1; height: 380px; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.08);">
<img src="./releases/gallery/mobile/mobile_11_print_receipt.png.jpg" alt="Invoice & Receipting" style="width: 100%; height: 100%; object-fit: cover; object-position: top; display: block;" />
</div>
<div style="background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 12px; display: flex; flex-direction: column; gap: 6px; min-height: 120px;">
<div style="display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 2px 6px; border-radius: 4px; background: rgba(6, 182, 212, 0.15); color: #8be9fd; border: 1px solid rgba(6, 182, 212, 0.2); display: inline-block;">Mobile App</span>
...
<details>
  ...
  * **01. Secure Google Login Portal**
    ![Desktop Login](./releases/gallery/desktop/desktop_01_login.png)
  * **02. Premium Educator Onboarding**
    ![Desktop Onboarding](./releases/gallery/desktop/desktop_02_onboarding.png)
  * **03. Command Center Dashboard**
    ![Desktop Dashboard](./releases/gallery/desktop/desktop_03_dashboard.png)
  * **04. Batch & Student Directory**
    ![Desktop Batches](./releases/gallery/desktop/desktop_04_batches.png)
  * **05. Student Profile & Transaction Ledger**
    ![Desktop Student Profile](./releases/gallery/desktop/desktop_05_student_profile.png)
  * **06. Dossier & Performance Ledger**
    ![Desktop Dossier Ledger](./releases/gallery/desktop/desktop_06_dossier_ledger.png)
  * **07. Roll Roster (Attendance)**
    ![Desktop Attendance](./releases/gallery/desktop/desktop_07_attendance.png)
  * **08. Fee Management & Ledger**
    ![Desktop Finances](./releases/gallery/desktop/desktop_08_finances.png)
  * **09. Exams & Cohort Grades**
    ![Desktop Exams](./releases/gallery/desktop/desktop_09_exams.png)
  * **10. AI Progress Dossier Studio**
    ![Desktop AI Reports](./releases/gallery/desktop/desktop_10_ai_reports.png)
  * **11. Printed Invoice Sheet**
    ![Desktop PDF Invoice](./releases/gallery/desktop/desktop_11_pdf_invoice.png)
  ...
  * **01. Mobile Login Screen**
    ![Mobile Login](./releases/gallery/mobile/mobile_01_login.png.png)
  * **02. Mobile Tutor Onboarding**
    ![Mobile Onboarding](./releases/gallery/mobile/mobile_02_onboarding.png.png)
  * **03. Mobile Command Dashboard**
    ![Mobile Dashboard](./releases/gallery/mobile/mobile_03_dashboard.png.png)
  * **04. Mobile Batch Lists**
    ![Mobile Batches](./releases/gallery/mobile/mobile_04_batches.png.png)
  * **05. Mobile Student Profile**
    ![Mobile Student Profile](./releases/gallery/mobile/mobile_05_student_profile.png.png)
  * **06. Mobile Dossier Analytics**
    ![Mobile Dossier Chart](./releases/gallery/mobile/mobile_06_dossier_chart.png.png)
  * **07. Mobile Attendance Marker**
    ![Mobile Attendance](./releases/gallery/mobile/mobile_07_mark_attendance.png.png)
  * **08. Mobile Fee Accounts**
    ![Mobile Finances](./releases/gallery/mobile/mobile_08_finances.png.png)
  * **09. Mobile Exam Records**
    ![Mobile Exams](./releases/gallery/mobile/mobile_09_exams.png.png)
  * **10. Mobile AI Dossier Generation**
    ![Mobile AI Reports](./releases/gallery/mobile/mobile_10_ai_reports.png.png)
  * **11. Mobile Invoice Print Sheet**
    ![Mobile Print Receipt](./releases/gallery/mobile/mobile_11_print_receipt.png.jpg)
</details>
